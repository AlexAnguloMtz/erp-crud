...
public class CreateUserCommandHandler {
    ...
    public void handle(CreateUserCommand command) {
        ...
        CreatePersonalDetailsCommand createPersonalDetailsCommand = personalDetailsModelMapper.toPersonalDetailsCreationCommand(
                accountCreationResponse.accountId(),
                command
        );
