package com.aram.erpcrud.modules.useraggregator.rest;
...
import com.aram.erpcrud.modules.useraggregator.application.UserFacade;
...
public class UserAggregatorController {
    ...
    public UserAggregatorController(UserFacade usersFacade) {
