...
((SELECT id FROM producto WHERE nombre='Pan de caja grande' LIMIT 1), 25),
((SELECT id FROM producto WHERE nombre='Pan dulce' LIMIT 1), 40),
((SELECT id FROM producto WHERE nombre='Leche Entera 1L' LIMIT 1), 30),
((SELECT id FROM producto WHERE nombre='Yogur Natural 1L' LIMIT 1), 20),
((SELECT id FROM producto WHERE nombre='Diezmillo de res' LIMIT 1), 15),
((SELECT id FROM producto WHERE nombre='Pollo pechuga' LIMIT 1), 35),
((SELECT id FROM producto WHERE nombre='Manzana' LIMIT 1), 50),
((SELECT id FROM producto WHERE nombre='Plátano' LIMIT 1), 45),
((SELECT id FROM producto WHERE nombre='Salsa de tomate' LIMIT 1), 55),
((SELECT id FROM producto WHERE nombre='Frijoles' LIMIT 1), 30),
((SELECT id FROM producto WHERE nombre='Pepsi 355ML' LIMIT 1), 60),
((SELECT id FROM producto WHERE nombre='Pepsi 600ML' LIMIT 1), 50),
((SELECT id FROM producto WHERE nombre='Coca-Cola 355ML' LIMIT 1), 40),
((SELECT id FROM producto WHERE nombre='Coca-Cola 600ML' LIMIT 1), 35),
((SELECT id FROM producto WHERE nombre='Papitas Sabritas' LIMIT 1), 55),
((SELECT id FROM producto WHERE nombre='Doritos' LIMIT 1), 25),
((SELECT id FROM producto WHERE nombre='Frescolita 1L' LIMIT 1), 20),
((SELECT id FROM producto WHERE nombre='Frescolita Zero 355 ML' LIMIT 1), 15),
((SELECT id FROM producto WHERE nombre='Leche 1L' LIMIT 1), 30),
((SELECT id FROM producto WHERE nombre='Yogur Natural 1L' LIMIT 1), 25),
((SELECT id FROM producto WHERE nombre='Harina de maíz 1 KG' LIMIT 1), 45),
((SELECT id FROM producto WHERE nombre='Tortillas' LIMIT 1), 50),
((SELECT id FROM producto WHERE nombre='Café Tradicional' LIMIT 1), 35),
((SELECT id FROM producto WHERE nombre='Café Descafeinado' LIMIT 1), 20),
((SELECT id FROM producto WHERE nombre='Salsa verde' LIMIT 1), 40),
((SELECT id FROM producto WHERE nombre='Salsa roja' LIMIT 1), 30),
((SELECT id FROM producto WHERE nombre='Spaghetti 250 G' LIMIT 1), 25),
((SELECT id FROM producto WHERE nombre='Fusilli 250 G' LIMIT 1), 15),
((SELECT id FROM producto WHERE nombre='Yogurt bebible 350ML' LIMIT 1), 20),
((SELECT id FROM producto WHERE nombre='Yakult bebible 600ML' LIMIT 1), 30),
((SELECT id FROM producto WHERE nombre='Galletas Clásicas' LIMIT 1), 55),
((SELECT id FROM producto WHERE nombre='Galletas Chocolate' LIMIT 1), 50),
((SELECT id FROM producto WHERE nombre='Sopa instantánea' LIMIT 1), 40),
((SELECT id FROM producto WHERE nombre='Sopa con Pollo' LIMIT 1), 35),
((SELECT id FROM producto WHERE nombre='Atole Tradicional' LIMIT 1), 30),
((SELECT id FROM producto WHERE nombre='Atole Chocolate' LIMIT 1), 20),
((SELECT id FROM producto WHERE nombre='Tortillas de maíz' LIMIT 1), 60),
((SELECT id FROM producto WHERE nombre='Tortillas de harina' LIMIT 1), 50);
